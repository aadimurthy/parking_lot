...
test_parking_command(_)->
    ...
    ?assertEqual("\nSlot No.\tRegistration No\t\tColour\n1\t\tKA-01-HH-1234\t\tWhite\n2\t\tKA-01-HH-9999\t\tWhite\n3\t\tKA-01-BB-0001\t\tBlack\n4\t\tKA-01-HH-2701\t\tBlue", parking_lot_allocation_server:status()),
    ok.
...
test_reg_number_grouping(_)->
    ...
    ?assertEqual([10,"KA-01-BB-0001"], parking_lot_allocation_server:group_reg_number_with("Black")),
    ?assertEqual([10,"KA-01-HH-1234",44,32,"KA-01-HH-9999",44,32,"KA-01-BB-0002"], parking_lot_allocation_server:group_reg_number_with("White")),
    ?assertEqual("\nNot found", parking_lot_allocation_server:group_reg_number_with("Red")),
    ok.
...
test_slot_number_grouping(_)->
    ...
    parking_lot_execute_commands:execute(["park", "KA-01-BB-0001", "Black"]),
    parking_lot_execute_commands:execute(["park", "KA-01-BB-0002", "White"]),
    ?assertEqual("\n1, 2, 4", parking_lot_allocation_server:group_slots_with({colour,"White"})),
    ?assertEqual("\nNot found", parking_lot_allocation_server:group_slots_with({reg_number,"1234"})),
    ?assertEqual("\n4", parking_lot_allocation_server:group_slots_with({reg_number,"KA-01-BB-0002"})),
    ok.
